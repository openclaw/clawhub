...
Baseline: ead4d9a0b9. Candidate: bda3eb6f24b219cac75b0827deb857891e904f27.
...
- Final copy: SkillSpector by NVIDIA; A.I.G by Tencent. Descriptions and Learn more links unchanged.
- Harness: node /tmp/claw-735-final-proof/capture.mjs nvidia; node /tmp/claw-735-final-proof/capture.mjs tencent. All four screenshots and recorded interaction frames inspected.
- Checks: ci:static exit 0; ci:unit exit 0 (6492 passed, 3 skipped); targeted scanner suite exit 0 (42 passed), both required package tsc checks exit 0. Full ci:types-build passed for the previous implementation; final-head CI will run before merge.
