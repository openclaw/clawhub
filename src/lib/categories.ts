...
export const PLUGIN_CATEGORIES: SkillCategory[] = [
  ...
  },
  {
    ...
    label: "Observability",
    icon: "activity",
    keywords: ["observability", "log", "trace", "monitor", "metric", "telemetry", "diagnostic", "exporter", "prometheus", "otel"],
  },
  {
    slug: "automation",
    label: "Automation",
  ...
  },
  {
    ...
    label: "Deployment",
    icon: "rocket",
    keywords: ["deploy", "release", "publish", "ci", "cd", "infrastructure", "gateway", "load-balanced"],
  },
  {
    slug: "dev-tools",
