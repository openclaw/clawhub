  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="[--discord-accent:#5865F2] [--publish-accent:var(--status-success-fg)] [display:block] w-[min(calc(100vw-2rem),620px)] overflow-hidden rounded-[calc(var(--radius-md)+8px)] border-[color:color-mix(in_srgb,var(--publish-accent)_22%,var(--line))] bg-[color:var(--surface)] p-0 shadow-[0_34px_90px_-36px_rgba(0,0,0,0.62),0_0_0_1px_color-mix(in_srgb,var(--ink)_8%,transparent)] focus:outline-none sm:p-0"
        style={{ display: "block" }}
      >
