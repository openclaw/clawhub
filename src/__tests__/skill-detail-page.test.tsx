...
describe("SkillDetailPage", () => {
  ...
  it("shows capability signals when a version has tags but no scan verdict yet", async () => {
    useQueryMock.mockImplementation((_fn: unknown, args: unknown) => {
      if (args === "skip") return undefined;
      if (args && typeof args === "object" && "skillId" in args) return [];
      return undefined;
        ...
        initialData={{
          result: {
            skill: {
              ...
              slug: "paytoll",
              displayName: "PayToll",
              summary: "Wallet-backed paid tools.",
              ownerUserId: ownerId,
              ownerPublisherId,
              tags: {},
              badges: {},
    ...
    expect(await screen.findByRole("heading", { name: "PayToll" })).toBeTruthy();
