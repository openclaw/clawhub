---
summary: "How to submit a copyright or other content rights concern about material published on ClawHub."
read_when:
...
content may be hidden, restored, or left unchanged.

For unsafe marketplace content that is not a content rights concern, use the
normal reporting flow described in [Moderation and Account Safety](./moderation.md).
For vulnerabilities in ClawHub itself, see [Security](./security.md).
