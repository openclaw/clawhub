...
<Tip>
  **Looking for a walkthrough?** See [Tool Plugins](./tool-plugins.md),
  [Channel Plugins](./sdk-channel-plugins.md), or
  [Provider Plugins](./sdk-provider-plugins.md) for step-by-step guides.
</Tip>
...
[Setup and Config](./sdk-setup.md#setup-entry) for when this matters.
...
- [SDK Overview](./sdk-overview.md) - registration API and subpath reference
- [Runtime Helpers](./sdk-runtime.md) - `api.runtime` and `createPluginRuntimeStore`
- [Setup and Config](./sdk-setup.md) - manifest, setup entry, deferred loading
- [Channel Plugins](./sdk-channel-plugins.md) - building the `ChannelPlugin` object
- [Provider Plugins](./sdk-provider-plugins.md) - provider registration and hooks
