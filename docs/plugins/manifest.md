...
For compatible bundle layouts, see [Plugin bundles](./bundles.md).
...
ClawHub validates the same package and manifest contract before publication:

```bash
clawhub package validate .
```

See the full plugin system guide: [Plugins](https://docs.openclaw.ai/tools/plugin).
...
- For runtime wizard metadata that requires provider code, see [Provider runtime hooks](https://docs.openclaw.ai/plugins/architecture-internals#provider-runtime-hooks).
...
<CardGroup cols={3}>
  <Card title="Building plugins" href="./building-plugins.md" icon="rocket">
    Getting started with plugins.
  </Card>
  <Card title="Plugin architecture" href="https://docs.openclaw.ai/plugins/architecture" icon="diagram-project">
    Internal architecture and capability model.
  </Card>
  <Card title="SDK overview" href="./sdk-overview.md" icon="book">
