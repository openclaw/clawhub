...
<CardGroup cols={2}>
  <Card title="Channel plugins" href="./sdk-channel-plugins.md">
    Step-by-step guide that uses these helpers in context for channel plugins.
  </Card>
  <Card title="Provider plugins" href="./sdk-provider-plugins.md">
...
<ParamField path="api.pluginConfig" type="Record">
...
- [SDK entry points](./sdk-entrypoints.md) — `definePluginEntry` options
- [SDK overview](./sdk-overview.md) — subpath reference
