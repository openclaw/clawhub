...
See [Advanced exec approvals](https://docs.openclaw.ai/tools/exec-approvals-advanced#plugin-approval-forwarding)
...
See [Codex harness runtime](https://docs.openclaw.ai/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
...
- [Plugin hooks](./hooks.md#tool-call-policy)
- [Building plugins](./building-plugins.md#registering-agent-tools)
- [Advanced exec approvals](https://docs.openclaw.ai/tools/exec-approvals-advanced#plugin-approval-forwarding)
- [Gateway protocol](https://docs.openclaw.ai/gateway/protocol)
- [Codex harness runtime](https://docs.openclaw.ai/plugins/codex-harness-runtime#native-permissions-and-mcp-elicitations)
