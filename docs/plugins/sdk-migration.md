...
<Note>
  External ClawHub publishers should use the public replacement imports shown
  here, then run `clawhub package validate .` and a publish dry run. Commands
  that reference `pnpm`, `src/`, `scripts/`, or `extensions/` are for
  contributors working inside the OpenClaw repository.
</Note>
...
<Steps>
  ...
  <Step title="Migrate approval-native handlers to capability facts">
    ...
    See [Channel plugins](./sdk-channel-plugins.md) for the current approval
    capability layout.
  ...
  <Step title="Build and test">
    ...
    OpenClaw contributors migrating a bundled plugin should also run its
    targeted repository test lane and `pnpm check`.
...
- [Getting Started](./building-plugins.md) - build your first plugin
- [SDK Overview](./sdk-overview.md) - full subpath import reference
- [Channel Plugins](./sdk-channel-plugins.md) - building channel plugins
- [Provider Plugins](./sdk-provider-plugins.md) - building provider plugins
- [Plugin Internals](https://docs.openclaw.ai/plugins/architecture) - architecture deep dive
- [Plugin Manifest](./manifest.md) - manifest schema reference
