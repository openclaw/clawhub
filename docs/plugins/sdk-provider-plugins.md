...
<Tip>
  ...
  events, pair the provider with an [agent harness](https://docs.openclaw.ai/plugins/sdk-agent-harness)
...
<Steps>
  <Step title="Package and manifest">
    ...
    are required in `package.json`. Configure your package build to emit
    `dist/index.js`; ClawHub rejects TypeScript-only published runtime entries.
  ...
  <Step title="Add runtime hooks (as needed)">
    ...
    <Accordion title="All available provider hooks">
      ...
      For detailed descriptions and real-world examples, see [Internals: Provider Runtime Hooks](https://docs.openclaw.ai/plugins/architecture-internals#provider-runtime-hooks).
    </Accordion>
  ...
  <Step title="Add extra capabilities (optional)">
    ...
    **hybrid-capability** plugin - the recommended pattern for company plugins
    ...
    [Internals: Capability Ownership](https://docs.openclaw.ai/plugins/architecture#capability-ownership-model).
  ...
  <Step title="Test">
    ...
    Run the repository's test script and ClawHub compatibility validation:
...
- [Channel Plugins](./sdk-channel-plugins.md) - if your plugin also provides a channel
- [SDK Runtime](./sdk-runtime.md) - `api.runtime` helpers (TTS, search, subagent)
- [SDK Overview](./sdk-overview.md) - full subpath import reference
- [Plugin Internals](https://docs.openclaw.ai/plugins/architecture-internals#provider-runtime-hooks) - hook details and bundled examples

## Related

- [Plugin SDK setup](./sdk-setup.md)
- [Building plugins](./building-plugins.md)
- [Building channel plugins](./sdk-channel-plugins.md)
