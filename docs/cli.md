...
- Checks the resolved version hash with TrentClaw before download. Vulnerable TrentClaw
  verdicts require interactive confirmation, or `--force` in non-interactive mode. Malicious
