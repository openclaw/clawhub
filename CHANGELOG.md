...
- GitHub Actions/CLI/API: bind OpenClaw package mutations to exact child, parent, candidate, tooling, and inventory receipts; consume scoped capabilities with non-public staging, then require an immutable successful parent attempt before final publication.
