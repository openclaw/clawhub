...
- GitHub Actions/CLI/API: bind OpenClaw package mutations to exact child, parent, candidate, tooling, and inventory receipts; mint scoped server capabilities only after live verification, then reverify and consume the publish capability atomically with release insertion.
