...
The package and skill feeds also keep a bounded 30-day revision and change
journal. Each revision stores
...
The stable snapshot endpoints are `/api/v1/feeds/plugins`,
`/api/v1/feeds/skills`, and `/api/v1/feeds/promotions`. Each snapshot
