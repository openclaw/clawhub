...
export function isKnownSpdx(spdx) {
...
export const LICENSE_PRESETS = {
    ...
    'CC-BY-NC-4.0': { transferable: true, commercialUse: false, commercialAttribution: false, derivativesAllowed: true, derivativesAttribution: true, derivativesApproval: false, derivativesReciprocal: false, summary: 'Non-commercial use only. Derivatives allowed with attribution.' },
    'CC-BY-NC-SA-4.0': { transferable: true, commercialUse: false, commercialAttribution: false, derivativesAllowed: true, derivativesAttribution: true, derivativesApproval: false, derivativesReciprocal: true, summary: 'Non-commercial use only. Derivatives must use the same license.' },
