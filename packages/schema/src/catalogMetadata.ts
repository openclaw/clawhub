...
export const PLUGIN_CATEGORY_DEFINITIONS = [
  ...
  },
  {
    ...
    icon: "book-open",
    description:
      "Building, selecting, compacting, or managing the active conversation context, including selecting and formatting the tools presented to the model. Durable memory belongs in Memory; an engine that runs the agent and owns its native sessions belongs in Agent runtimes.",
  },
  {
    slug: "voice",
    label: "Voice",
  ...
  },
  {
    ...
    icon: "globe",
    description:
      "General web search, fetching, crawling, and extracting web content. Interactive browser control belongs in Computer use. A tool whose main purpose is a specific research or business workflow belongs in that workflow's category.",
  },
  {
    slug: "computer-use",
    label: "Computer use",
    icon: "monitor",
    description:
      "Controlling desktop and browser interfaces through navigation, clicks, typing, and screenshots. Web search and content extraction belong in Web; hosting execution environments belongs in Infrastructure; participating in meetings belongs in Voice.",
  },
  {
    slug: "media",
    label: "Media",
  ...
  },
  {
    ...
    icon: "inbox",
    description:
      "Managing email, inboxes, team communication, and collaborative workspaces, including reply notifications, message triage, and communication personas over existing channels. Providing the messaging transport itself belongs in Channels.",
  },
  {
    slug: "productivity",
    label: "Productivity",
    icon: "list-todo",
    description:
      "Managing tasks, notes, projects, plans, and personal or team work, including reviewing work activity and history. Appointments and availability belong in Scheduling; document processing belongs in Documents & files.",
  },
  {
    slug: "scheduling",
    label: "Scheduling",
