...
export async function cmdPackageStorePackMigrationStatus(
  ...
  console.log(`Missing sample: ${String(result.missingSampleSize ?? "unknown")}`);
  console.log(`Generated sample: ${String(result.generatedStorePackSampleSize ?? "unknown")}`);
  console.log(`Generated bytes: ${String(result.generatedStorePackBytes ?? "unknown")}`);
}
...
export async function cmdPackageStorePackBackfill(
  ...
  console.log(`Processed: ${String(result.processed ?? "unknown")}`);
  console.log(`Succeeded: ${String(result.succeeded ?? "unknown")}`);
  console.log(`Failed: ${String(result.failed ?? "unknown")}`);
}
