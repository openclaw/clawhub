...
describe("publisher abuse dry-run persistence", () => {
  ...
  it("streams pending dashboard queues by latest score rank until a visible item is found", async () => {
        ...
        return {
          withIndex: (
            ...
            return {
              order: () => ({
                first: async () =>
                  constraints.modelVersion === "publisher-abuse-pressure.v2" ? latestRun : null,
              }),
            };
          },
        };
    ...
    expect(scoreRunModels).toEqual(["publisher-abuse-pressure.v2", "publisher-abuse-temporal.v1"]);
  });
