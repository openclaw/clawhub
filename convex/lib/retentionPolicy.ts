...
export const RETENTION_POLICIES = {
  ...
  catalogFeedIndexedEntries: ephemeral("Revision-pinned catalog query index.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeed.pruneCatalogFeedHistoryInternal",
    retention: "Thirty days after publication.",
  }),
  catalogFeedQueryMaterializations: ephemeral("Signed-query materialization metadata.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeed.pruneCatalogFeedHistoryInternal",
    retention: "At most fifteen minutes after creation.",
  }),
  catalogFeedQueryResults: ephemeral("Ordered rows for a signed query materialization.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeed.pruneCatalogFeedHistoryInternal",
    retention: "At most fifteen minutes after creation.",
  }),
  catalogFeedShardPublications: ephemeral("Revision-pinned catalog shard roots.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeedShards.pruneCatalogFeedShardsInternal",
    retention: "Thirty days after publication.",
  }),
  catalogFeedShards: ephemeral("Immutable catalog shard representation bytes.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeedShards.pruneCatalogFeedShardsInternal",
    retention: "Thirty days after publication.",
  }),
  catalogFeedShardDescriptors: ephemeral("Lightweight signed-root shard descriptors.", {
    expirationField: "expirationTime",
    expirationIndex: "by_expiration_time",
    prune: "catalogFeedShards.pruneCatalogFeedShardsInternal",
    retention: "Thirty days after publication.",
  }),
  catalogFeedPublicationLeases: ephemeral("Recoverable hosted catalog publication lease.", {
    expirationField: "expirationTime",
    prune: "catalogFeed.acquireCatalogFeedPublicationLease usage-time replacement",
    retention: "Thirty minutes after acquisition, or immediate release after publication.",
  }),
